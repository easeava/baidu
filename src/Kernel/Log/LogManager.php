...
namespace EaseBaidu\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('EaseBaidu', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/easebaidu/easebaidu.log', $this->level(['level' => 'debug'])
        )]));
    }
    ...
    protected function createSyslogDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SyslogHandler(
                    'EaseBaidu', $config['facility'] ?? LOG_USER, $this->level($config))
            ),
        ]);
    }
